...
/**
 * Gets the distance from `body1` to `body2`.
 *
 * @param body a pointer to a body returned from body_init()
...
/**
 * Gets the net forc e acting on the body
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's force vector
 */
vector_t body_get_net_force(body_t *body);

/**
 * Gets the net impulse acting on the body's velocity
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's impulse vector
 */
vector_t body_get_net_impulse(body_t *body);

/**
 * @brief Gets the rotational veocity of the object
 *
 * @param body
 * @return angular speed of body (positive means counterclockwise rotation)
 */
...
/**
 * @brief Sets the rotational velocity of `body` to `rot_velocity`
 *
 * @param body a pointer to a body returned from body_init()
 * @param rot_velocity the new rotational velocity of the body
 */
void body_set_rot_velocity(body_t *body, double rot_velocity);

/**
 * @brief Rotate body a certain angle RELATIVE to current angle about centroid
 * Positive angles mean counterclockwise rotation.
 *
 * @param body a pointer to a body returned from body_init()
 * @param angle the angle for which the body should be rotated
 */
void body_rotate(body_t *body, double angle);

/**
 * @brief Rotate body a certain angle around a given point
 * Positive angles mean counterclockwise rotation.
 *
 * @param body a pointer to a body returned from body_init()
 * @param angle the angle for which the body should be rotated
...
/**
 * @brief adds a vertex to the body
 *
 * @param body a pointer to a body returned from body_init()
 * @param vector a vector representing the vertex to be added to the body
 */
...
/**
 *removes all forces attached to a current body
 *
 * @param body a pointer to a body returned from body_init()
 */
void body_remove_all_forces(body_t *body);
