...
/**
 * Creates a rectangle with the given width and height, centered at (0, 0)
 * Adds top-left corner first, then counter-clockwise
...
/**
 * Constructs a regular polygon with the given radius centered at (0, 0)
 * Adds along positive x-axis first, then counter-clockwise
 *
 * @return list of
 */
...
/**
 * Prints items in the list for testing purposes
 *
 * @param list a pointer to a list returned from list_init()
 *
 */
