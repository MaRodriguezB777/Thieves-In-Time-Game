...
/**
 * @brief Gets the average of two vectors through the average of the
 * coordinates.
 *
 * @param v1
 * @param v2
...
/**
 * @brief Gets the length (norm) of a vector
 *
 * @param v
 * @return the length of the vector
 */
double vec_length(vector_t v);

/**
 * @brief Gets the comp of the first vector in the direction of second vector,
 * which is a unit vector
 *
 * @param v1 vector
 * @param u1 unit vector
 * @return vector_t component of `v1` in the direction of `u1`
 */
double vec_component(vector_t v1, vector_t u1);

/**
 * @brief Print the vector v in form "(v.x, v.y)""
 *
 * @param v
 */
