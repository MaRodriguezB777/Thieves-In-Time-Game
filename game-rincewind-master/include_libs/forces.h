 ...
 */
void create_newtonian_gravity(scene_t *scene, double grav_const, body_t *body1,
                              body_t *body2);
 ...
 * @param body1 the first body
 * @param body2 the second body
 * @param body1_is_destroyable whether body1 is destroyed in the collision
 * @param body2_is_destroyable whether body2 is destroyed in the collision
 */
...
/**
 * Adds a force creator to a scene that destroys two bodies after they have
 * collided a certain number of times. The bodies should be destroyed by calling
 * body_remove(). This should be represented as an on-collision callback
 * registered with create_collision().
 *
 * @param scene the scene containing the bodies
 * @param body1 the first body
 ...
 * @param body2_is_destroyable whether body2 is destroyed in the collision
 */
void create_delayed_destructive_collision(scene_t *scene, body_t *body1,
                                          body_t *body2,
                                          bool body1_is_destroyable,
                                          bool body2_is_destroyable,
                                          size_t collisions_before_destruction);
/**
